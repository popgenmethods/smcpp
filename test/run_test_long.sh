...
$SMC estimate --multi --em-iterations 1 -o $TMP/out/1 --unfold --knots 5 --em-iterations 1 1.25e-8 $TMP/example.1.smc.gz
$SMC estimate --multi --em-iterations 1 -o $TMP/out/1 --unfold --knots 5 --timepoints 33 1000 --em-iterations 1 1.25e-8 $TMP/example.1.smc.gz
$SMC estimate --multi --em-iterations 1 -p 0.01 -r 1e-8 -o $TMP/out/2 --knots 5 --em-iterations 1 1.25e-8 $TMP/example.2.smc.gz
